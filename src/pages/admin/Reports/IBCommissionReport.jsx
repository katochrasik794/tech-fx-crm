  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 lg:ml-64 mt-12 p-4 lg:p-8 w-full bg-gray-50 min-h-screen">
        <h1 className="text-lg font-bold mb-4">IB Commission Report</h1>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-white rounded shadow p-6 text-center">
            ...
            <div className="text-sm text-gray-600 border-t border-orange-500 pt-2">Total Commission</div>
          </div>
          <div className="bg-white rounded shadow p-6 text-center">
            <div className="text-3xl font-bold mb-2">0</div>
            <div className="text-sm text-gray-600 border-t border-orange-500 pt-2">Total Volume</div>
          </div>
        </div>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-y border-black bg-gray-50">
                ...
                <th className="py-0.5 px-2 text-left font-semibold">Phone</th>
                <th className="py-0.5 px-2 text-left font-semibold">Country</th>
                <th className="py-0.5 px-2 text-left font-semibold">IB Name</th>
                <th className="py-0.5 px-2 text-left font-semibold">Total Lots</th>
                <th className="py-0.5 px-2 text-left font-semibold">Total Commission</th>
                <th className="py-0.5 px-2 text-left font-semibold">Marketing Name</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td colSpan="9" className="py-4 px-2 text-center text-gray-500">
                  No data available
                </td>
              </tr>
            </tbody>
...
export default IBCommissionReport;
