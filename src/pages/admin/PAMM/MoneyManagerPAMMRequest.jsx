...
const MoneyManagerPAMMRequest = () => {
  ...
  return (
    <div className="flex">
      ...
      <h1 className="text-lg font-bold mb-4">Money Manager PAMM Request</h1>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-y border-black bg-gray-50">
                ...
                <th className="py-0.5 px-2 text-left font-semibold">Min. Investment</th>
                <th className="py-0.5 px-2 text-left font-semibold">Performance Fee</th>
                <th className="py-0.5 px-2 text-left font-semibold">Per Deal/Per Lot</th>
                <th className="py-0.5 px-2 text-left font-semibold">Fees</th>
            ...
            <tbody>
              {data.length === 0 ? (
                <tr>
                  <td colSpan="10" className="py-4 px-2 text-center text-gray-500">
                ...
                data.map((item, index) => (
                  <tr key={item.id} className={index % 2 === 0 ? 'bg-gray-100' : 'bg-white'}>
                    ...
                    <td className="py-0.5 px-2">{item.minInvestment}</td>
                    <td className="py-0.5 px-2">{item.performanceFee}</td>
                    <td className="py-0.5 px-2">{item.perDealPerLot}</td>
                    <td className="py-0.5 px-2">{item.fees}</td>
...
export default MoneyManagerPAMMRequest;
