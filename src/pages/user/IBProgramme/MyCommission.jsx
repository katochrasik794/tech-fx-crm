          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            <div className="flex-1 w-full min-w-0">
              <div className="bg-white rounded-lg sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-sm">
                ...
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-center mb-4 sm:mb-5 lg:mb-6">My Commission</h2>
                ...
                <div className="text-center py-12 sm:py-16 lg:py-20 text-gray-400">
                  <DollarSign className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4" />
                  <p className="text-lg sm:text-xl">No commissions yet!</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-96 flex-shrink-0">
              <div className="bg-white rounded-lg sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-sm">
                <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Commission Summary</h3>
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-gray-50 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1">Total Earned</p>
                  ...
                  <div className="bg-gray-50 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1">Available to Withdraw</p>
