...
import { ArrowLeft, Banknote, TrendingUp, TrendingDown, CheckCircle, ArrowUpRight, BarChart3 } from 'lucide-react'
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            <div className="flex-1 w-full min-w-0">
              <div className="bg-white rounded-lg sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-sm">
                ...
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-center mb-4 sm:mb-5 lg:mb-6">Withdraw Report</h2>
                ...
                <div className="text-center py-12 sm:py-16 lg:py-20 text-gray-400">
                  ...
                  <p className="text-lg sm:text-xl">No withdrawals yet!</p>
                </div>
              </div>
            </div>
