...
import { ArrowLeft, TrendingUp, TrendingDown, CheckCircle, ArrowUpRight, BarChart3 } from 'lucide-react'
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
            <div className="flex-1 w-full min-w-0">
              <div className="bg-white rounded-lg sm:rounded-2xl p-3 sm:p-4 lg:p-6 shadow-sm">
                ...
                <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-center mb-4 sm:mb-5 lg:mb-6">Summary Report</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Total Deposits</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">$100</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Total Withdrawals</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600">$0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Net Balance</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold">$100</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Total Trades</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold">0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Winning Trades</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Losing Trades</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-600">0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Total Profit</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">$0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Total Loss</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-600">$0</p>
                  </div>
                  <div className="bg-gray-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl">
                    <p className="text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">Win Rate</p>
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold">0%</p>
                  </div>
                </div>
              </div>
