...
function AdminDashboard() {
  ...
  const stats = [
    { label: 'Total Clients', value: '74', icon: User, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/list' },
    { label: 'Total IB', value: '12', icon: Users, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/ib/users' },
    { label: 'Pending Clients', value: '1', icon: FileText, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/pending-docs' },
    { label: 'Pending Deposit', value: '2', icon: DollarSign, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/transaction/pending-deposit' },
    { label: 'Pending Withdraw', value: '0', icon: DollarSign, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/transaction/pending-withdraw' },
    { label: 'Pending IB Withdraw', value: '1', icon: DollarSign, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/transaction/pending-ib-withdraw' },
    { label: 'Active Traders', value: '9', icon: DollarSign, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/list' },
    { label: 'FTD Users', value: '9', icon: User, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/list' },
    { label: 'Non FTD Users', value: '78', icon: User, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/list' },
    { label: 'Pending IB Request', value: '0', icon: User, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/ib/requests' },
    { label: 'Pending Bank Details Request', value: '1', icon: User, iconBg: 'bg-gray-100', iconColor: 'text-violet-500', link: '/admin/user/bank-list' }
  ]
  ...
  return (
    <ResponsiveAdminLayout title="Dashboard">
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200">
                  ...
                  <Link to={stat.link} className="text-violet-500 text-xs sm:text-sm font-semibold hover:text-orange-600">View more</Link>
                </div>
              )
            })}
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 mb-6 sm:mb-8">
            <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
              ...
              <button 
                ...
                className={`px-4 sm:px-6 py-1.5 sm:py-2 rounded text-xs sm:text-sm font-semibold ${chartView === 'clients' ? 'text-violet-500 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                Clients
              </button>
            </div>
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 mb-3 sm:mb-4 text-xs sm:text-sm">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 sm:w-4 sm:h-4 text-violet-500"></div>
                <span>Deposit</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200">
              <div className="flex items-start justify-between">
                ...
                <div className="bg-orange-100 p-2 sm:p-3 rounded-full">
                  <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 text-violet-500" />
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200">
              <div className="flex items-start justify-between">
                ...
                <div className="bg-orange-100 p-2 sm:p-3 rounded-full">
                  <Wallet className="w-5 h-5 sm:w-6 sm:h-6 text-violet-500" />
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200">
      ...
      <div className="text-center py-4 text-xs sm:text-sm text-gray-600">
        Copyright © 2025 <span className="text-violet-500 font-semibold">FinCRM MT5 CRM</span>, All Rights Reserved.
      </div>
