...
import { Edit, Eye, Settings, Trash2 } from 'lucide-react'
...
function PendingDocumentsList() {
  ...
  const documents = [
    { id: 1, name: 'Test11!', email: 'kelana4532@bitfami.com', phone: '+1 85855855855', registrationDate: '2025-09-24', marketingName: 'new marketting' },
  ]
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 lg:ml-64 mt-12 p-4 lg:p-8 w-full bg-gray-50 min-h-screen">
        <h1 className="text-xl font-bold mb-6">Pending Documents List</h1>
