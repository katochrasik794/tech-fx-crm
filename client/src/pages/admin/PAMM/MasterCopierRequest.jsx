...
const MasterCopierRequest = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [entriesPerPage, setEntriesPerPage] = useState(10);
  const [currentPage, setCurrentPage] = useState(1);

  const data = [
    { id: 1, name: 'Demo user', email: 'demouser032@demo.com', performanceFee: '30', userType: 'master', registrationDate: '2025-09-16' }
  ];
  ...
  return (
    <div className="flex">
      ...
      <h1 className="text-lg font-bold mb-4">Master Copier Request</h1>
...
export default MasterCopierRequest;
